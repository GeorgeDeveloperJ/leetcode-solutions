...
```
Utilizando *hash maps* la solucion es sencilla e intuitiva. Usando el reduce como funcion para ir sumando
cada elemento con un accumulator. Ademas el ternary operator para que cuando el valor sea tipo
IV En el I en vez de sumarse se reste.